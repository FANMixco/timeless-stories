const CACHE_VERSION = "memory-game-pwa-20260525-mobile-tutorial-icon";
const APP_SHELL = [
  "/memory-game.html",
  "/memory-game.webmanifest",
  "/css/poppins.min.css",
  "/css/icon-moon-memory.min.css",
  "/css/memory-game.min.css?v=20260525-mobile-tutorial-icon",
  "/js/memory-game.min.js?v=20260525-mobile-tutorial-icon",
  "/js/pwa.min.js",
