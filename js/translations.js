...
fetchData(`js/i18n/lang-${lang}.min.json`)
    .then((data) => {
        ...
        if (picture && lang === 'es') {
            picture.innerHTML = `
            <source srcset="img/cover-colorized-v2-es.webp" type="image/webp">
            <source srcset="img/cover-colorized-v2-es.jpg" type="image/jpeg">
            <img style="width: 100%;" alt="Historias Eternas de El Salvador V2"
                src="img/cover-colorized-v2-es.jpg" />
        `;
        }
