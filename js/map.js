...
function addLegendMarkers(mapInstance, items, language, mapTranslations, collectionKey) {
  items.forEach((obj) => {
    ...
    const popupContent = legend.desc
...
function createLegendMap(mapId, items, center, zoom, language, mapTranslations, collectionKey) {
  ...
  addLegendMarkers(mapInstance, items, language, mapTranslations, collectionKey);
  return mapInstance;
}
